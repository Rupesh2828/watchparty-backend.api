...
export const createWebcamSlot = async (req, res) => {
...
export const getWebcamSlotById = async (req, res) => {
    try {
        const { id } = req.params;
        if (!id) {
...
export const getAllWebcamSlots = async (req, res) => {
    try {
        const { watchPartyId, userId } = req.params;
        const whereClause = {};
        if (watchPartyId)
            whereClause.watchPartyId = parseInt(watchPartyId);
        if (userId)
...
export const updateWebcamSlot = async (req, res) => {
    const { id } = req.params;
...
export const deleteWebcamSlot = async (req, res) => {
    const { id } = req.params;
    try {
        if (!id) {
            res.status(400).json({ message: "id is required." });
...
export const assignWebcamSlot = async (req, res) => {
    const { id } = req.params;
...
export const unassignWebcamSlot = async (req, res) => {
    const { id } = req.params;
    try {
        if (!id) {
            res.status(400).json({ message: "id is required." });
